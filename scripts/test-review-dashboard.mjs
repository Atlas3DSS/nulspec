...
const baseTask = {
  ...
  priority: "urgent",
  queued_reason:
    "GLM and Kimi completed the model-review gate; publication still requires a human decision.",
  ...
  source: {
    ...
    release_review_consensus_sha256: hash("d"),
  },
  brief:
  ...
  review_events: [
    {
      ...
      summary: "The independent release review returned a valid PASS.",
      cost_usd: 0.15760631,
      trace_sha256: hash("4"),
      consensus_eligible: true,
    },
    {
      event_id: "RELEASE-KIMI-20260802-001",
      reviewer: "Kimi",
    ...
    {
      event_id: "RELEASE-CODEX-20260802-001",
      reviewer: "Codex",
      provider: "OpenAI plan",
      model: "codex-plan-adjudicator",
      outcome: "summary_only",
      validation: "completed_valid",
      summary: "Codex prepared a trace summary without changing the model gate.",
      cost_usd: 0,
      trace_sha256: hash("6"),
  ...
  publication_gate: {
    reason:
      "The GLM/Kimi model gate passed; the exact packet still requires a human publication disposition.",
